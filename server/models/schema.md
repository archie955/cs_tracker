...
Users, Players, Matches, PlayerMatches, Weapons, Grenades, Player Opens, Player Clutches, Player Side? (unsure)
...
If someone hasn't made an account, then we only collect users, matches, and player matches. Weapons, grenades, opens, clutches etc are not gathered.